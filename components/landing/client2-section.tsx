    ...
    >
      <div className="py-14">
        <div className="mx-auto max-w-screen-xl px-4 md:px-8">
			<h3 className="text-5xl font-bold tracking-tight text-black dark:text-white sm:text-6xl">
...
<br></br>
<br></br>
			<div><h4 className="text-xl font-bold tracking-tight text-black dark:text-white">Flexible Solutions for Companies of All Sizes </h4>
			</div>
